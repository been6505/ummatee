...
const AdminPhotoFrame = lazyWithReload(() => import('./pages/AdminPhotoFrame.jsx'))
...
export default function App() {
  ...
  const STANDALONE = {
    ...
    'admin-photo-frame': AdminPhotoFrame,
  }
