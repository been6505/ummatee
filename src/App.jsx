...
const AdminMoney = lazy(() => import('./pages/AdminMoney.jsx'))

// แมประหว่าง URL path กับชื่อหน้า
const PATH_TO_PAGE = { '/': 'home', '/home': 'home', '/donation': 'donation', '/event': 'iftar', '/event/iftar-for-gaza': 'iftar', '/event/give-for-um': 'give', '/missions/qurban2026': 'qurban', '/missions/quban2026': 'qurban', '/admin/event/iftar2026': 'admin-iftar', '/admin/missions/qurban2026': 'admin-qurban', '/admin/missions/qurban2026/edit': 'admin-qurban-edit', '/admin/donations': 'admin-donations', '/admin/calendar': 'admin-calendar', '/admin/money': 'admin-money', '/admin/dashboard': 'admin-home' }
...
export default function App() {
  ...
  if (page === 'admin-money') return <Suspense fallback={null}><AdminMoney /></Suspense>
