...
// เวลาที่จะใช้จริง: liveScheduledAt (datetime-local "YYYY-MM-DDTHH:mm") ถ้าไม่มีก็ถอยไปใช้
// วันเวลาโพสต์ปกติ — โพสต์ไลฟ์เก่าหลายอันตั้งไว้แต่ date/time ยังไม่มีช่องเวลาไลฟ์แยก
// ถ้าไม่ถอยให้ ไลฟ์พวกนั้นจะหายจากตารางทั้งที่มีอยู่จริง
