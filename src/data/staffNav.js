import {
  ...
  faBullseye, faFlag, faVideo, faClockRotateLeft, faListCheck, faTowerBroadcast, faCalendarWeek,
...
export const STAFF_NAV_GROUPS = [
  ...
  { label: 'ปฏิทินรายสัปดาห์', icon: faCalendarWeek, href: '/admin/week', requireRoles: ['admin', 'staff', 'social'] },
